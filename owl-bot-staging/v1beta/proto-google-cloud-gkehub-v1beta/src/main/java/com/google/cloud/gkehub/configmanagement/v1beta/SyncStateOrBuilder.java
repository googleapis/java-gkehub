...
public interface SyncStateOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.gkehub.configmanagement.v1beta.SyncState)
   ...
   * @return The code.
   */
  com.google.cloud.gkehub.configmanagement.v1beta.SyncState.SyncCode getCode();
   ...
   */
  java.util.List<com.google.cloud.gkehub.configmanagement.v1beta.SyncError> 
      getErrorsList();
  /**
   * <pre>
   * A list of errors resulting from problematic configs.
   ...
   * <code>repeated .google.cloud.gkehub.configmanagement.v1beta.SyncError errors = 6;</code>
   */
  com.google.cloud.gkehub.configmanagement.v1beta.SyncError getErrors(int index);
  /**
   * <pre>
   * A list of errors resulting from problematic configs.
   * This list will be truncated after 100 errors, although it is
   ...
   * <code>repeated .google.cloud.gkehub.configmanagement.v1beta.SyncError errors = 6;</code>
   */
  java.util.List<? extends com.google.cloud.gkehub.configmanagement.v1beta.SyncErrorOrBuilder> 
