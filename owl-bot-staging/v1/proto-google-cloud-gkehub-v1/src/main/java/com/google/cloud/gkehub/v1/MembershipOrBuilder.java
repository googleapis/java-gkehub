...
public interface MembershipOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.gkehub.v1.Membership)
   ...
   * <code>.google.cloud.gkehub.v1.MembershipEndpoint endpoint = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.gkehub.v1.MembershipEndpointOrBuilder getEndpointOrBuilder();
   ...
   * <code>.google.cloud.gkehub.v1.MembershipState state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.gkehub.v1.MembershipStateOrBuilder getStateOrBuilder();
