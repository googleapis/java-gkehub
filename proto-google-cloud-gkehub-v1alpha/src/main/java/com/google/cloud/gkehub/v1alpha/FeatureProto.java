  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "source.proto\032Egoogle/cloud/gkehub/v1alpha/cloudauditlogging/cloudauditlogging.pr"
          + "oto\032Cgoogle/cloud/gkehub/v1alpha/configmanagement/configmanagement.proto\0323google"
          + "/cloud/gkehub/v1alpha/metering/metering.proto\032Igoogle/cloud/gkehub/v1alpha/multi"
          + "clusteringress/multiclusteringress.proto\0329google/cloud/gkehub/v1alpha/servicemes"
          + "h/servicemesh.proto\032\037google/protobuf/tim"
          + "estamp.proto\032\034google/api/annotations.proto\"\367\007\n"
          + "\007Feature\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022@\n"
          + "\006labels\030\002 \003(\01320.google.cloud.gkehub.v1alpha.Feature.LabelsEntry\022N\n"
          + "\016resource_state\030\003 "
          + "\001(\01321.google.cloud.gkehub.v1alpha.FeatureResourceStateB\003\340A\003\022A\n"
          + "\004spec\030\004 \001(\0132..goog"
          + "le.cloud.gkehub.v1alpha.CommonFeatureSpecB\003\340A\001\022X\n"
          + "\020membership_specs\030\005 \003(\01329.googl"
          + "e.cloud.gkehub.v1alpha.Feature.MembershipSpecsEntryB\003\340A\001\022C\n"
          + "\005state\030\006 \001(\0132/.google"
          + ".cloud.gkehub.v1alpha.CommonFeatureStateB\003\340A\003\022Z\n"
          + "\021membership_states\030\007 \003(\0132:.googl"
          + "e.cloud.gkehub.v1alpha.Feature.MembershipStatesEntryB\003\340A\003\0224\n"
          ...
          + ".google.cloud.gkehub.v1alpha.MembershipFeatureSpec:\0028\001\032l\n"
          + "\025MembershipStatesEntry\022\013\n"
          + "\003key\030\001 \001(\t\022B\n"
          + "\005value\030\002 \001(\01323.google.clo"
          + "ud.gkehub.v1alpha.MembershipFeatureState:\0028\001:^\352A[\n"
          + "\035gkehub.googleapis.com/Feature"
          + "\022:projects/{project}/locations/{location}/features/{feature}\"\313\001\n"
          + "\024FeatureResourceState\022F\n"
          + "\005state\030\001"
          + " \001(\01627.google.cloud.gkehub.v1alpha.FeatureResourceState.State\"k\n"
          + "\005State\022\025\n"
          ...
          + " \001(\0132<.google.cloud.gkehub.multiclusteringress.v1alpha.FeatureSpecH\000\022W\n"
          + "\021cloudauditlogging\030l \001(\0132:.google.cloud.gkehu"
          + "b.cloudauditlogging.v1alpha.FeatureSpecH\000B\016\n"
          + "\014feature_spec\"\262\001\n"
          + "\022CommonFeatureState\022L\n"
          + "\013servicemesh\030d \001(\01325.google.cloud.gke"
          + "hub.servicemesh.v1alpha.FeatureStateH\000\022=\n"
          + "\005state\030\001"
          + " \001(\0132).google.cloud.gkehub.v1alpha.FeatureStateB\003\340A\003B\017\n\r"
          + "feature_state\"\201\001\n"
          + "\025MembershipFeatureSpec\022X\n"
          + "\020configmanagement\030j"
          + " \001(\0132<.google.cloud.gkehub.configmanagement.v1alpha.MembershipSpecH\000B\016\n"
          + "\014feature_spec\"\332\002\n"
          + "\026MembershipFeatureState\022O\n"
          + "\013servicemesh\030d \001(\01328.google.cloud.gkehub"
          + ".servicemesh.v1alpha.MembershipStateH\000\022I\n"
          + "\010metering\030h"
          + " \001(\01325.google.cloud.gkehub.metering.v1alpha.MembershipStateH\000\022Y\n"
          + "\020configmanagement\030j \001(\0132=.google.cloud.gkehu"
          + "b.configmanagement.v1alpha.MembershipStateH\000\0228\n"
          + "\005state\030\001 \001(\0132).google.cloud.gkehub.v1alpha.FeatureStateB\017\n\r"
          + "feature_stateB\321\001\n"
          + "\037com.google.cloud.gkehub.v1alphaB\014FeatureProtoP\001ZAgoogle.golang.org/genproto/"
          + "googleapis/cloud/gkehub/v1alpha;gkehub\252\002"
          + "\033Google.Cloud.GkeHub.V1Alpha\312\002\033Google\\Cl"
          + "oud\\GkeHub\\V1alpha\352\002\036Google::Cloud::GkeHub::V1alphab\006proto3"
    };
    descriptor =
